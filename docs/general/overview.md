...
useful visual and program interface. It uses the ISO 8583 E-pay protocol for transaction sending
...
The Signal builds like a kit of weakly connected modules, like a Parser, Connector, Queue, etc. It allows to 
