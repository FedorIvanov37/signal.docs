...
|----------------------|-----------------------|------------------------------------------------------------------------------------|------------------------------------------|--------------------------------| 
| Incoming Transaction | `JSON`, `DUMP`, `INI` | Hotkey `Ctrl + O`, button `Open File` or drop file to the MainWindow on Signal GUI | Argument `--file FILE` or `--dir DIR`    | Endpoint `/api/transactions`   |
